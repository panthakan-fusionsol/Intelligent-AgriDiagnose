...
LABELS = ["blight","rust","virus","mildew","healthy","spot"];
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log", type=str, default="results.csv")
    ...
    if "gpt4.1" in str(args.model).lower():
...
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model gpt-4.1 --log gpt4_1_224.csv --rpm 60
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model gemini-2.5-flash --log gemini_2_5_flash_224.csv --rpm 50
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model gemini-2.5-pro --log gemini_2_5_pro_224.csv --rpm 50
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model claude-sonnet-4-20250514 --log claude-sonnet-4-20250514_224.csv --rpm 50
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model qwen3-vl-235b-a22b-instruct --log qwen3-vl-235b-a22b-instruct_224.csv --rpm 50
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model gpt-4o --log gpt-4o_224.csv --rpm 60
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model gpt-5 --log gpt-5_224.csv --rpm 120
# /bin/python3 /mnt/c/fusion/corn_project/agent_test.py --image_dir /mnt/c/fusion/corn_project/All_Crops/test --model resnet18 --log resnet18_224.csv --rpm 0 --weight_path /mnt/c/fusion/corn_project/model_training/resnet18_224_cosine_croponly_6_b32/checkpoints/best.pth